...
export const scenes: Record<string, Scene> = {
  ...
  "outdoor-play": {
    id: "outdoor-play",
    text: "Playground time! Everyone runs outside into the sunshine. Shai goes down the big slide — wheee! Cru and Desi play on the swings, Mia Alexandra and Aila dig in the sandbox, and Mia Alma plays tag with Mason. The teachers watch and clap and laugh. What a perfect day!",
